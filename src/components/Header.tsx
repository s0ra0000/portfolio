...
const Header = () => {
    return (
        <section id="header" className="bg-dark flex justify-center items-center font-poppins">
            <div className="flex flex-col-reverse md:flex-row w-[1200px] justify-around items-center md:justify-around h-screen">
                <header className="text-white md:h-full flex flex-col justify-start items-center md:w-1/2 w-full h-1/2 md:h-screen md:justify-center">
