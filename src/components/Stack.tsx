        ...
        <>
            <div className="flex bg-dark justify-center items-center h-screen font-poppins">
                <div className="flex flex-col w-[1200px] items-center justify-center text-white">
                    <h1 className="text-2xl md:text-4xl font-bold">My Tech Stack</h1>
                    <div className="mt-14 grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-x-12 md:gap-x-20 lg:gap-x-32 gap-y-10 md:gap-y-12 lg:gap-y-20">
                        ...
                        <div className="w-[50px] md:w-[100px]">
                            ...
                            <p className="w-full text-center block my-1 font-bold text-xs mdtext-sm tracking-wide">
                                TAILWIND
                            </p>
                        </div>
                        <div className="w-[50px] md:w-[100px]">
                        ...
                        <div className="flex flex-col justify-between w-[50px] md:w-[100px]">
